 ...
 * @since 1.0.0
 */
class Architecturer_Gallery_Fullscreen extends Widget_Base {
	...
	public function get_name() {
		return 'photographer-gallery-fullscreen';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Gallery', 'architecturer-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'effect',
			[
				'label' => __( 'Transition Effect', 'architecturer-elementor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'slide',
			    'options' => [
			     	'slide' => __( 'Slide', 'architecturer-elementor' ),
			     	'fade' => __( 'Fade', 'architecturer-elementor' ),
			     	'cube' => __( 'Cube', 'architecturer-elementor' ),
			     	'coverflow' => __( 'Coverflow', 'architecturer-elementor' ),
			     	'flip' => __( 'Flip', 'architecturer-elementor' ),
			    ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'hover',
			    'options' => [
			     	'hover' => __( 'On Hover', 'architecturer-elementor' ),
			     	'always' => __( 'Always', 'architecturer-elementor' ),
			     	'hide' => __( 'Hide', 'architecturer-elementor' ),
			    ],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#000000',
		        'selectors' => [
		            '{{WRAPPER}} .tg_fullscreen_gallery_wrapper' => 'background: {{VALUE}}',
		            '{{WRAPPER}} .tg_fullscreen_gallery_wrapper .tg_fullscreen_gallery .swiper-slide' => 'background-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .swiper-slide .tg_gallery_fullscreen_content .tg_gallery_fullscreen_title' => 'font-size: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .swiper-wrapper .tg_gallery_fullscreen_content .tg_gallery_fullscreen_title' => 'letter-spacing: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
			    ...
			    'selectors' => [
		            '{{WRAPPER}} .swiper-wrapper .swiper-slide .tg_gallery_fullscreen_content .tg_gallery_fullscreen_title' => 'text-transform: {{VALUE}}',
		        ],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .swiper-slide .tg_gallery_fullscreen_content .tg_gallery_fullscreen_caption' => 'font-size: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .swiper-wrapper .tg_gallery_fullscreen_content .tg_gallery_fullscreen_caption' => 'letter-spacing: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
			    ...
			    'selectors' => [
		            '{{WRAPPER}} .swiper-wrapper .swiper-slide .tg_gallery_fullscreen_content .tg_gallery_fullscreen_caption' => 'text-transform: {{VALUE}}',
		        ],
			]
		);
	...
	protected function render() {
		include(ARCHITECTURER_ELEMENTOR_PATH.'templates/gallery-fullscreen/index.php');
	}
