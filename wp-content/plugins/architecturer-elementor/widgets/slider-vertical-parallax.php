 ...
 * @since 1.0.0
 */
class Architecturer_Slider_Vertical_Parallax extends Widget_Base {
	...
	public function get_name() {
		return 'photographer-slider-vertical-parallax';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Vertical Parallax Slider', 'architecturer-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'lodash', 'architecturer-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_background:before' => 'background-color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_content_wrapper .tg_parallax_slide_content_title h2' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_content_title h2' => 'font-size: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} div.tg_parallax_slide_content_wrapper div.tg_parallax_slide_content_title h2' => 'font-weight: {{SIZE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_background .tg_parallax_slide_content_title h2' => 'letter-spacing: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_content_wrapper .tg_parallax_slide_content_title h2' => 'line-height: {{SIZE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
			    ...
			    'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_background .tg_parallax_slide_content_wrapper .tg_parallax_slide_content_title h2' => 'text-transform: {{VALUE}}',
		        ],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_content_subtitle' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_content_subtitle' => 'font-size: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_content_wrapper .tg_parallax_slide_content_subtitle' => 'letter-spacing: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
			    ...
			    'selectors' => [
		            '{{WRAPPER}} .tg_parallax_slide_background .tg_parallax_slide_content_subtitle' => 'text-transform: {{VALUE}}',
		        ],
			]
		);
	...
	protected function render() {
		include(ARCHITECTURER_ELEMENTOR_PATH.'templates/slider-vertical-parallax/index.php');
	}
