 ...
 * @since 1.0.0
 */
class Architecturer_Gallery_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'photographer-gallery-masonry';
	}
	...
	public function get_title() {
		return __( 'Masonry Gallery', 'architecturer-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'masonry', 'architecturer-elementor' ];
	}
	...
	protected function render() {
		include(ARCHITECTURER_ELEMENTOR_PATH.'templates/gallery-masonry/index.php');
	}
