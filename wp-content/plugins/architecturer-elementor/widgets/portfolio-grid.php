 ...
 * @since 1.0.0
 */
class Architecturer_Portfolio_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'architecturer-portfolio-grid';
	}
	...
	public function get_title() {
		return __( 'Portfolio Grid', 'architecturer-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ffffff',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio_grid_wrapper h3' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} div.portfolio_grid_wrapper h3' => 'font-size: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .portfolio_grid_wrapper h3.portfolio_grid_title' => 'line-height: {{SIZE}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} div.portfolio_grid_wrapper h3.portfolio_grid_title' => 'letter-spacing: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
			    ...
			    'selectors' => [
		            '{{WRAPPER}} .portfolio_grid_wrapper figcaption h3.portfolio_grid_title' => 'text-transform: {{VALUE}}',
		        ],
			]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default' => '#ebebeb',
		        'selectors' => [
		            '{{WRAPPER}} .portfolio_grid_wrapper figcaption .portfolio_grid_subtitle' => 'color: {{VALUE}}',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} .portfolio_grid_wrapper figcaption div.portfolio_grid_subtitle' => 'font-size: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'size_units' => [ 'px' ],
		        'selectors' => [
		            '{{WRAPPER}} div.portfolio_grid_wrapper figcaption div.portfolio_grid_subtitle' => 'letter-spacing: {{SIZE}}{{UNIT}};',
		        ],
		    ]
		);
		...
		$this->add_control(
			...
			[
			    ...
			    'selectors' => [
		            '{{WRAPPER}} div.portfolio_grid_wrapper figcaption .portfolio_grid_subtitle' => 'text-transform: {{VALUE}}',
		        ],
			]
		);
	...
	protected function render() {
		include(ARCHITECTURER_ELEMENTOR_PATH.'templates/portfolio-grid/index.php');
	}
