 ...
 * @since 1.0.0
 */
class Architecturer_Gallery_Justified extends Widget_Base {
	...
	public function get_name() {
		return 'photographer-gallery-justified';
	}
	...
	public function get_title() {
		return __( 'Justified Gallery', 'architecturer-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'justifiedGallery', 'architecturer-elementor' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'row_height',
		    [
		        'label' => __( 'Row Height', 'architecturer-elementor' ),
		...
		$this->add_control(
		    'margin',
		    [
		        'label' => __( 'Margin', 'architecturer-elementor' ),
		        'type' => Controls_Manager::SLIDER,
		        'default' => [
		            'size' => 5,
		        ],
		...
		$this->add_control(
			'justify_last_row',
			[
				'label' => __( 'Justify Last Row', 'architecturer-elementor' ),
	...
	protected function render() {
		include(ARCHITECTURER_ELEMENTOR_PATH.'templates/gallery-justified/index.php');
	}
