	...
	if(!empty($images))
	{
		...
		switch($settings['columns']['size'])
		{
		   	...
		   	case 3:
		   		...
		   		$thumb_image_name = 'architecturer-gallery-masonry';
		   	break;
...
?>
<div class="gallery_grid_content_wrapper do_masonry layout_<?php echo esc_attr($column_class); ?> <?php echo esc_attr($spacing_class); ?>" data-cols="<?php echo esc_attr($settings['columns']['size']); ?>">
<?php		
		$last_class = '';
		$count = 1;
...
?>
		<div class="gallery_grid_item <?php echo esc_attr($column_class); ?> <?php echo esc_attr($last_class); ?> <?php echo esc_attr($hover_class); ?>">
			<?php
				if($is_lighbox)	
				{
			?>
