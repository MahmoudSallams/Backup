...
?>
<section class="tg_slider_property_clip_wrapper intro" style="width:<?php echo intval($settings['width']['size']).$settings['width']['unit']; ?>;<?php echo esc_attr($height_style); ?>">
