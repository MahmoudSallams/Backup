<?php
	...
	if(!empty($slides))
	{
		...
		$thumb_image_name = 'architecturer-gallery-list';
?>
...
?>
		<div class="distortion_grid_item distortion_grid_item--bg theme-<?php echo esc_attr($theme_code); ?>">
			<div class="distortion_grid_item-img" data-displacement="<?php echo plugins_url( '/architecturer-elementor/assets/images/distortion-grid/' ); ?><?php echo esc_attr($displacement); ?>" data-intensity="<?php echo esc_attr($intensity); ?>" <?php echo $speed_in; ?> <?php echo $speed_out; ?> <?php echo $additional_attr; ?>>
