...
<?php
	...
	{		
		...
		$column_class = 1;
		$thumb_image_name = 'architecturer-gallery-grid';
...
<div class="portfolio_filter_wrapper">
		<a class="filter_tag_btn active" href="javascript:;" data-rel="all" data-cols="<?php echo esc_attr($settings['columns']['size']); ?>"><?php echo __( 'All', 'architecturer-elementor' ); ?></a>
	<?php
		foreach ( $filterable_tags as $filterable_tag ) 
		{
	?>
		<a class="filter_tag_btn" href="javascript:;" data-rel="<?php echo $filterable_tag; ?>" data-cols="<?php echo esc_attr($settings['columns']['size']); ?>"><?php echo esc_html($filterable_tag); ?></a>
	<?php
		}
	?>
</div>
...
?>
<div class="portfolio_grid_content_wrapper portfolio_grid layout_<?php echo esc_attr($column_class); ?> <?php echo esc_attr($spacing_class); ?>" data-cols="<?php echo esc_attr($settings['columns']['size']); ?>">
<?php		
		$last_class = '';
		$count = 1;
...
?>
		<div class="portfolio_grid_wrapper <?php echo esc_attr($column_class); ?> <?php echo esc_attr($last_class); ?>  portfolio-<?php echo esc_attr($count); ?> tile scale-anm <?php echo $slide['slide_tag']; ?> all <?php echo esc_attr($filterable_class); ?>">
			...
			<figcaption>
				...
				<div class="portfolio_grid_subtitle"><?php echo esc_html($slide['slide_subtitle']); ?></div>
			</figcaption>
