...
?>
<div class="slider_parallax_wrapper" data-autoplay="<?php echo intval($timer); ?>" data-pagination="<?php echo intval($pagination); ?>" data-navigation="<?php echo intval($navigation); ?>" style="height:<?php echo intval($settings['height']['size']).$settings['height']['unit']; ?>;">
