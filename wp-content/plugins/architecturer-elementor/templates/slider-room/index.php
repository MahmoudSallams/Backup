		...
		<div class="room <?php if($counter == 0) { ?>room--current<?php }?>">
			...
			?>
				...
				<?php
					...
					{
						$image_id = architecturer_get_image_id($slide['slide_image'][0]['url']);
				...
				?>
					<img class="room__img" src="<?php echo esc_url($image_url[0]); ?>" alt="<?php echo esc_attr($image_alt);?>"/>
				<?php
					}
				?>
				<?php
					...
					{
						$image_id = architecturer_get_image_id($slide['slide_image'][1]['url']);
			...
			?>
				...
				<?php
					...
					{
						$image_id = architecturer_get_image_id($slide['slide_image'][3]['url']);
				...
				<?php
					...
					{
						$image_id = architecturer_get_image_id($slide['slide_image'][4]['url']);
				...
				<div class="room__side room__side--left">
					...
					<?php
						...
						{
							$image_id = architecturer_get_image_id($slide['slide_image'][2]['url']);
			...
			?>
				...
				<div class="room__side room__side--right">
					<?php
						...
						{
							$image_id = architecturer_get_image_id($slide['slide_image'][5]['url']);
					...
					<?php
						...
						{
							$image_id = architecturer_get_image_id($slide['slide_image'][6]['url']);
					...
					<?php
						...
						{
							$image_id = architecturer_get_image_id($slide['slide_image'][7]['url']);
...
?>
		<div class="slide">
			<h2 class="slide__name"><?php echo esc_html($slide['slide_title']); ?></h2>
			...
			?>
			<p class="slide__date"><a class="button" href="<?php echo esc_url($slide['slide_link']['url']); ?>" <?php echo esc_attr($target); ?>><?php echo esc_html($slide['slide_link_title']); ?></a></p>
		</div>
<?php
			$counter++;
		}
