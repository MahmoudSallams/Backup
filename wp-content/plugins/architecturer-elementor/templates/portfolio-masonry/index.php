...
?>
		<div class="portfolio_masonry_grid_wrapper gallery_grid_item <?php echo esc_attr($column_class); ?> <?php echo esc_attr($last_class); ?>  portfolio-<?php echo esc_attr($count); ?> tile scale-anm <?php echo $slide['slide_tag']; ?> all <?php echo esc_attr($filterable_class); ?>">
