...
?><!DOCTYPE html>
<html <?php language_attributes(); ?> <?php if(isset($architecturer_homepage_style) && !empty($architecturer_homepage_style)) { echo 'data-style="'.esc_attr($architecturer_homepage_style).'"'; } ?> data-menu="<?php echo esc_attr($tg_menu_layout); ?>">
<head>
...
<body <?php body_class(); ?>>
	...
	<input type="hidden" id="tg_footer_reveal" name="tg_footer_reveal" value="<?php echo esc_attr($tg_footer_reveal); ?>"/>
	<input type="hidden" id="pp_topbar" name="pp_topbar" value="<?php echo esc_attr($tg_topbar); ?>"/>
	<input type="hidden" id="post_client_column" name="post_client_column" value="4"/>
	<input type="hidden" id="pp_back" name="pp_back" value="<?php esc_html_e('Back', 'architecturer' ); ?>"/>
	...
	?>
	<div id="wrapper" class="<?php if(!empty($architecturer_page_menu_transparent)) { ?>hasbg<?php } ?> <?php if(!empty($page_menu_transparent)) { ?>transparent<?php } ?>">
 ...
 jQuery ("#interior").addClass('slectecdactive');
  jQuery ("#interior").click(function(){ 
    jQuery ("div#type2").hide();
    jQuery ("div#type1").show();
 jQuery ("#interior").addClass('slectecdactive');
      jQuery ("#exterior").removeClass('slectecdactive');


  });
  jQuery ("#exterior").click(function(){
    jQuery ("div#type2").show();
    jQuery ("div#type1").hide();
     jQuery ("#exterior").addClass('slectecdactive');

     jQuery ("#interior").removeClass('slectecdactive');
