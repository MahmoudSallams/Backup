...
if(is_admin() && isset($_POST['method']) && !empty($_POST['method']) && $_POST['method'] == 'clear_cache')
{
	...
	{
		$cache_dir = ARCHITECTURER_THEMEUPLOAD;
	}
...
{
	$json_file_name = ARCHITECTURER_THEMENAME.'Theme_Export_'.date('m-d-Y_hia');
...
//If delete sidebar
if(is_admin() && isset($_POST['sidebar_id']) && !empty($_POST['sidebar_id']) && current_user_can('manage_options'))
{
