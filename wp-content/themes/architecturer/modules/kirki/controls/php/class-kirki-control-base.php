...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'architecturer' ),
				'remove'         => esc_attr__( 'Remove', 'architecturer' ),
				'default'        => esc_attr__( 'Default', 'architecturer' ),
				'selectFile'     => esc_attr__( 'Select File', 'architecturer' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'architecturer' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'architecturer' ),
			)
		);
