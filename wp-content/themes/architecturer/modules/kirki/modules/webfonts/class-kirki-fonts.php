...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'architecturer' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'architecturer' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'architecturer' ),
			'200'       => esc_attr__( 'Light 200', 'architecturer' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'architecturer' ),
			'300'       => esc_attr__( 'Book 300', 'architecturer' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'architecturer' ),
			'400'       => esc_attr__( 'Normal 400', 'architecturer' ),
			'regular'   => esc_attr__( 'Normal 400', 'architecturer' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'architecturer' ),
			'500'       => esc_attr__( 'Medium 500', 'architecturer' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'architecturer' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'architecturer' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'architecturer' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'architecturer' ),
			'700'       => esc_attr__( 'Bold 700', 'architecturer' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'architecturer' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'architecturer' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'architecturer' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'architecturer' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'architecturer' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'architecturer' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'architecturer' ),
		);
	}
