...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
		...
		<?php
		    ...
		    {
		     $small_image_url = wp_get_attachment_image_src($image_id, 'architecturer-blog', true);
		?>
		    <div class="post_img static">
			    ...
			    <div class="post_img_hover classic <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
			     	<?php 
				     	$blog_featured_img_url = get_the_post_thumbnail_url($post, 'architecturer-blog'); 
				     	$blog_featured_img_data = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), "architecturer-blog" );
				     	...
				     	{
				     ?>
				     <img <?php echo esc_attr($return_attr['source']); ?>="<?php echo esc_url($blog_featured_img_url); ?>" class="<?php echo esc_attr($return_attr['class']); ?>" alt="<?php echo esc_attr($blog_featured_img_alt); ?>"/>
				     <?php
					     }
					?>
